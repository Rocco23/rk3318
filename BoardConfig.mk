LOCAL_PATH := device/${T96}/${rk3318}

TARGET_BOARD_PLATFORM := rk3318               # From ro.mediatek.platform, but lowercase value
TARGET_NO_BOOTLOADER := true
TARGET_BOOTLOADER_BOARD_NAME := T96     # From ro.product.board
